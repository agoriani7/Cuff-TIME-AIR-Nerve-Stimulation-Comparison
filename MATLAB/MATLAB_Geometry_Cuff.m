...
model = ModelUtil.create('Nerve_CUFF_Electrode');
...
sil_mov.set('displz', 3); % Cuff at the centre of the nerve
...
endo_mat = model.component('comp1').material.create('endo'); % Anisotropic material
endo_mat.propertyGroup('def').set('electricconductivity', {'0.083', '0', '0', '0', '0.083', '0', '0', '0', '0.0571'})

sil_mat = model.component('comp1').material.create('sil');
sil_mat.propertyGroup('def').set('electricconductivity', {'1e-12'});
